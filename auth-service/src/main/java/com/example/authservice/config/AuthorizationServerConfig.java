...
import com.example.authservice.authentication.DeviceClientAuthenticationProvider;
import com.example.authservice.federation.FederatedIdentityIdTokenCustomizer;
import com.example.authservice.jose.Jwks;
import com.example.authservice.web.authentication.DeviceClientAuthenticationConverter;
